...
class Database:
    ...
    def _seed_data(self):
        ...
        insurance_types = [
            (
                "Дом",
                "property",
                '{"coverage": ["пожар", "затопление", "кража"]}',
                15000.00,
            ),
            (
                "Автомобиль - ОСАГО",
                "auto",
                '{"type": "ОСАГО", "coverage": ["гражданская ответственность"]}',
                5000.00,
            ),
            (
                "Автомобиль - КАСКО",
                "auto",
                '{"type": "КАСКО", "coverage": ["ущерб", "угон", "полная гибель"]}',
                30000.00,
            ),
        ]
    ...
    def get_insurance_types(self):
        ...
        return self.execute_query(
            "SELECT * FROM insurance_types ORDER BY category, name", fetchall=True
        )
